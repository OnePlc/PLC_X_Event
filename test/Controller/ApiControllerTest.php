 ...
 *
 * Test Class for Main Controller of Event Module
 *
 * @category Test
 * @package Event
...
namespace OnePlaceTest\Event\Controller;

use OnePlace\Event\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/event/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('event-api');
    }
}
