...
(NULL, 'select', 'web show', 'web_show', 'event-base', 'event-single', 'col-md-2', '', '/application/selectbool', 0, 1, 0, '', 'OnePlace\\BoolSelect', ''),
(NULL, 'select', 'web spotlight', 'web_spotlight', 'event-base', 'event-single', 'col-md-2', '', '/application/selectbool', 0, 1, 0, '', 'OnePlace\\BoolSelect', ''),
(NULL, 'select', 'confirm', 'event_confirm', 'event-base', 'event-single', 'col-md-2', '', '/application/selectbool', 0, 1, 0, '', 'OnePlace\\BoolSelect', '');
