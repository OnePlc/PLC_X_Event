...
Now that you have basic knowledge of oneplace event, we'll show you the easy way to get started.

## Install onePlace Event

The easiest way to get started is to install the event module via
Composer.
